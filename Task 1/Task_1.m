...
% Lets get the size of the provided dataset
...
%Display of all the features of the dataset (1vs1)

figure('Name','Dataset provided');
...
figure('Name','Solution, display of the features with largest correlation');
...
%Lets find the second largest correlation.
